...
public interface UserService {
	...
	/**
	 * Adds a new user
	 * @param loginName the login name to be registered
	 * @param clearPassword their password not encrypted
	 * @param userProfileDetails their dto
     ...
     * @param passwordIsEncrypted a boolean to tell if the password is encrypted
     ...
     * @param userProfileId the id
     * @param userProfileDetails the dto
     * @throws InstanceNotFoundException
     */
     ...
     * @param userProfileId user's id
     * @param oldClearPassword current clear password
     * @param newClearPassword new clear password
     * @throws IncorrectPasswordException
     * @throws InstanceNotFoundException
     */
     ...
     * @param userId the id to remove the user
     * @throws InstanceNotFoundException
     */
