...
public interface UserStoryService {
	 ...
	 * @param userStoryName its name
	 * @param userStoryDetails its details as a DTO
    ...
    /**
     * Updates a UserStory
     * @param userStoryId its id to look for it
     * @param userStoryDetails the details as a DTO
     * @throws InstanceNotFoundException
     */
