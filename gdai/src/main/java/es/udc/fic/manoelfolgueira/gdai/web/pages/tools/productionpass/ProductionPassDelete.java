...
public class ProductionPassDelete {
	...
	Object onValidateFromDeleteForm() {
		try {
			...
			return pageRenderLS.createPageRenderLinkWithContext("tools/productionPass/ProductionPassDeleted",
					productionPassId);
		} catch (InstanceNotFoundException e) {
			deleteForm.recordError(
					messages.get("error-productionPassDoesNotExist") + productionPassDetails.getProductionPassName());
			return null;
		}
	}
